...
<div className="restcontainer">
        ...
        <div className="colabGrid">
        <Amigos classN="colabsFols" name="Observatório de Aves do Instituto Butantã" fig="OAU.jpg.webp.png" link="https://www.facebook.com/observatoriodeavesibu" />
        <Amigos classN="colabsFols" name="Observatório de Aves da Costa Rica" fig="CRBO.jpg.webp.png" link="https://www.costaricabirds.org" />
        <Amigos classN="colabsFols" name="Observatório de Aves do Klamath" fig="KBO.png.webp.png" link="https://www.klamathbird.org" />
        <Amigos classN="colabsFols" name="Observatório de Aves da PUC-RS" fig="PUCRS.png.webp.png" link="http://www.pucrs.br/ima/projetos/observatorio-de-aves/" />
        <Amigos classN=" colabsFols" name="Un Poco del Chocó" fig="unpoco.png.webp.png" link="https://www.unpocodelchoco.com/" />

        <Amigos classN="colabsFols" name="Mata do Sauá" fig="matadosaua.jpg.webp.png" link="https://www.instagram.com/matadosaua/" />
        <Amigos classN=" colabsFols" name="Silo - Arte e Latitude Rural" fig="SILO.png.webp.png" link="https://www.silo.org.br" />
